...
public class SchedulingSolverTest 
{
	public static boolean test1()
	{
		try 
		{
			String json = "{\"EVENT\":[{\"id\":313,\"days_count\":2,\"duration\":\"80\",\"pStartTm\":{\"TH\":[\"0730\"]},\"space\":80,\"max_participants\":97,\"persons\":15,\"constraint\":[]}],\"SPACE\":[{\"id\":80,\"capacity\":97,\"times\":\"\"}]}";
	...
	public static boolean test2()
	{
		try 
		{
			String json = "{\"EVENT\":[{\"id\":316,\"days_count\":2,\"duration\":\"80\",\"pStartTm\":{\"TH\":[\"0730\"]},\"space\":82,\"max_participants\":103,\"persons\":15,\"constraint\":[]},{\"id\":317,\"days_count\":2,\"duration\":\"80\",\"pStartTm\":{\"TH\":[\"0730\"]},\"space\":82,\"max_participants\":103,\"persons\":16,\"constraint\":[]}],\"SPACE\":[{\"id\":82,\"capacity\":103,\"times\":\"\"},{\"id\":83,\"capacity\":102,\"times\":\"\"}]}";
			ParsedData data = parseJson(json);
